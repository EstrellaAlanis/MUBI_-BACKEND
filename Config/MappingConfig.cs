    ...
    public MappingConfig()
    {
        ...
        CreateMap<Usuario, UsuarioResponseDto>()
            .ForMember(dest => dest.Rol,
                opt => opt.MapFrom(src => src.Rol != null ? src.Rol.NombreRol : null));
        ...
        CreateMap<ComprobanteVenta, ComprobanteVentaResponseDto>()
            .ForMember(dest => dest.NumeroCompleto,
                opt => opt.MapFrom(src => src.Serie + "-" + src.Numero.ToString("D6")))
            .ForMember(dest => dest.Cliente,
                opt => opt.MapFrom(src => src.Cliente != null
                    ? $"{src.Cliente.Nombres} {src.Cliente.Apellidos}".Trim()
                    : null))
            .ForMember(dest => dest.DocumentoIdentidad,
                opt => opt.MapFrom(src => src.Cliente != null ? src.Cliente.DocumentoIdentidad : null))
            .ForMember(dest => dest.TipoCliente,
                opt => opt.MapFrom(src => src.Cliente != null ? src.Cliente.TipoCliente : null))
            .ForMember(dest => dest.Ruc,
                opt => opt.MapFrom(src => src.Cliente != null ? src.Cliente.Ruc : null))
            .ForMember(dest => dest.RazonSocial,
                opt => opt.MapFrom(src => src.Cliente != null ? src.Cliente.RazonSocial : null));

        CreateMap<CreateComprobanteVentaDto, ComprobanteVenta>();
